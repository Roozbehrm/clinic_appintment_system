    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(blank=True, help_text='برای کاربرانی که فقط با گوگل وارد شده\u200cاند خالی می\u200cماند.', max_length=15, null=True, unique=True, verbose_name='شماره تلفن')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar_pos_x', models.PositiveSmallIntegerField(default=50, verbose_name='موقعیت افقی آواتار (٪)')),
                ('avatar_pos_y', models.PositiveSmallIntegerField(default=50, verbose_name='موقعیت عمودی آواتار (٪)')),
